...
for (i in 1:100) {
  ...
  correct.var.oracle <- ECCCM:::estimateVarAdd(coef.vec / sd.y, cor.list.oracle, cov.mat, n.o, n.r, which(coef.vec != 0))$total
  ...
  pval.method <- ECCCM:::analyzeRef(marg.beta.hat = beta.report,
                                    x.r           = x.r,
                                    n.o           = n.o,
                                    method.filter = 'BH',
                                    sigma.method  = 'estimate',
